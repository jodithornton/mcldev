...
function thrive_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'               => 'BuddyPress Docs', // The plugin name.
			'slug'               => 'buddypress-docs', // The plugin slug (typically the folder name).
			'required'           => false, // If false, the plugin is only 'recommended' instead of required.
		),
		array(
		...
		array(
			'name'               => 'BuddyPress Global Search', // The plugin name.
			'slug'               => 'buddypress-global-search', // The plugin slug (typically the folder name).
			'required'           => false, // If false, the plugin is only 'recommended' instead of required.
		),
		array(
	 ...
	 */
	$config = array(
		'id'           => 'thrive',                 // Unique ID for hashing notices for multiple instances of TGMPA.
